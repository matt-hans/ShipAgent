 ...
 *
 * Port of React JobDetailPanel.tsx.
 * Displays full job information when a job is selected from the sidebar.
 * Shows job header, summary stats, row-level details, and action buttons.
 * Reads active job from JobStore signal.
 */
