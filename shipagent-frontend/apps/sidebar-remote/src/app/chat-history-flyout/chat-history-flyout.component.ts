 ...
 *
 * Overlay/flyout that shows the full message history of a selected
 * conversation session in read-only mode. Includes an export button.
 * Port of React ChatHistoryFlyout.tsx.
 *
 * Usage: rendered as overlay in SidebarContentComponent, controlled via
 * ConversationStore (separate open/close if needed, or shown by parent).
 */
...
@Component({
  selector: 'sa-chat-history-flyout',
  standalone: true,
